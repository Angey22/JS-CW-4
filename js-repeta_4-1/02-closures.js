 ...
 */
console.groupCollapsed('Функция возвращает => функцию'); //! Log group name
 ...
 * Поварёнок
 */
console.groupCollapsed('"Поварёнок" - пример использования "замыкания"'); //! Log group name
 ...
 * Округлятор 🤷‍♂️
 */
console.groupCollapsed('"Округлятор" - пример использования "замыкания"'); //! Log group name
 ...
 */
console.groupCollapsed('Приватные данные и функции'); //! Log group name
