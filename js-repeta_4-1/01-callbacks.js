 ...
 */
console.groupCollapsed('Функция обратного вызова (callback)'); //! Log group name
 ...
 */
console.groupCollapsed('Функция doMath(a, b, callback)'); //! Log group name
 ...
 */
console.groupCollapsed('Отложенный вызов'); //! Log group name
 ...
 */
console.groupCollapsed('Отложенный вызов: геолокация'); //! Log group name
 ...
 */
console.groupCollapsed('Отложенный вызов: интервалы'); //! Log group name
 ...
 */
console.groupCollapsed('Отложенный вызов: http-запрос'); //! Log group name
 ...
 * Фильтр
 */
console.groupCollapsed('Фильтр'); //! Log group name
