//! Видео - 0:39:00...0:53:40

/*
 * Цепочки вызовов - "chaining" методов.
 */
console.groupCollapsed('Цепочки вызовов - "chaining" методов'); //! Log group name
 ...
 * - потом сортируем
 */
console.groupCollapsed('Сортируем тех кто онлайн по рангу (по возрастанию ранга)'); //! Log group name
 ...
 */
console.groupCollapsed('Chaining в методах объекта как jquery'); //! Log group name
