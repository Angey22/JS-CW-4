 ...
 */
console.groupCollapsed('Array.prototype.find()'); //! Log group name

// Функция "find" предназначена для поиска одного уникального элемента в коллекции (первый поповшийся, который удовлетворяет условию поиска).
 ...
 * Ищем игрока по id
 */
console.groupCollapsed('Ищем игрока по id'); //! Log group name
 ...
 */
console.groupCollapsed('Ищем игрока по имени'); //! Log group name
